...
public class NumericSerializer {
    ...
    public static AbstractSerializer<Object> fullInstance = new RawSerializer();
    ...
    public static void putUnversionedDoubleOrLong(Number number, CodedOutputStream out) throws IOException {
    ...
    public static void serializeFullResMetric(Object o, byte[] buf) throws IOException {
        CodedOutputStream protobufOut = CodedOutputStream.newInstance(buf);
        byte type = typeOf(o);
    ...
    public static int sizeOf(Object o, byte type) throws IOException {
        int sz = 0;
        switch (type) {
            case Constants.B_I32:
                sz += 1 + 1; // version + type.
    ...
    public static byte typeOf(Object o) throws IOException {
    ...
    public static Object deserializeSimpleMetric(CodedInputStream in) throws IOException {
    ...
    public static void dumpBufferUnsafe(CodedInputStream in) {
        if (DUMP_BAD_BUFFERS) {
            try {
    ...
    public static class SimpleNumberSerializer extends AbstractSerializer<SimpleNumber> {
